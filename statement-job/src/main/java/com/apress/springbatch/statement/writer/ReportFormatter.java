...
public class ReportFormatter implements LineAggregator<Statement> {

    private static final String ADDRESS_FORMAT = "%s, %s, %s, %s, %s, %s\n\n";
    private static final String SUMMARY_HEADER_FORMAT = "Account Number:%s\n" ;

    private static final String SUMMARY_FORMAT = "Summary: %s, %s, %s\n";
    private static final String CASH_DETAIL_FORMAT = "Account Detail:%s\n";
    private static final String SECURITY_HOLDING_FORMAT = "Securities: %s, %s, %s\n";
